...
public class MainFragment extends Fragment {
    ...
    private FrameLayout content_ch;
    private Fragment FreeAction = new FreeActionFragment();//自由运动界面
    private Fragment SpecifyAction = new SpecifyActionFragment();//特定动作界面
