...
public class StartActionButton extends View {
    ...
    private static final String mTitleText = "开始运动";
    private static final String mButtonText = "暂停运动";
    ...
    public StartActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StartActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawContentItem(Canvas canvas) {
        ...
        drawContentItemsText(canvas, "自由运动", "开始", 1, mContentItemOnePaint);
        drawContentItemsText(canvas, "能量消耗", "开始", 2, mContentItemTwoPaint);
        drawContentItemsText(canvas, "动作跟踪", "开始", 3, mContentItemThreePaint);
    }
